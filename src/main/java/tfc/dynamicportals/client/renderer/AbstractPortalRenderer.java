...
public abstract class AbstractPortalRenderer<T extends AbstractPortal> {
    ...
    public abstract void drawDebug(T portal, MultiBufferSource.BufferSource source, PoseStack pPoseStack, Camera pCamera);

    public abstract void drawAntenna(T portal, VertexConsumer consumer, PoseStack pPoseStack, Camera pCamera);
}
